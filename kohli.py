...
def load_model_data():
    ...
    df = pd.read_csv('kohli_batting_data.csv', na_filter=True)


    # Handle missing values
    df['wicket_type'].fillna('No Wicket', inplace=True)  # or any default value you prefer
...
class KohliDLSModel:
    ...
    def train_model(self, df):
        ...
        feature_cols = ['balls_remaining', 'wickets_in_hand', 'resources_remaining',
        ...
        self.model.fit(self.scaler.transform(df[feature_cols]), df['runs_remaining'])
    ...
    def predict_score(self, situation_dict):
        ...
        scaled_features = self.scaler.transform(df_situation[feature_cols])
